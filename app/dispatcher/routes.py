...
async def check_data_handler(request: Dict, db: Session = Depends(get_db)):
    ...
    if check_webapp_signature(bot.token, data["_auth"]):
        ...
        _usertg.created=now
        #{id_chat: 422838854, is_bot: None, first_name: 'Kir179', last_name: 'sl', username: 'KirSl19', language_code: 'ru', photo_url: None}
        #id_chat=422838854, is_bot=None, first_name='Кирилл', last_name='sl', username='KirSl19', language_code='ru', photo_url=None
